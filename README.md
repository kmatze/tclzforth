...
```
   1. start tcl/tk shell, inside do:
   2. in the start directory should be
      - the files zforth.exe, zftiny.exe
      - the subdir forth with core.zf and dict.zf
...
```
   ...
   2.  zf save                                 // your are inside zForth -> save workspace as image "forth.save"
